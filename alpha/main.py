...
#TUTORIALS: https://pylessons.com/RL-BTC-BOT-NN
...
class CustomEnv:
    ...
    def __init__(self, df, initial_balance=1000, lookback_window_size=50, Render_range=100, Show_reward=False, normalize_value=40000):
        ...
        # Market history contains the OHCL values ( candles ) for the last lookback_window_size prices
    ...
    def step(self, action):
        ...
        if action == 0: # Hold
            ...
            openTrade(self.crypto_bought,self.trades)
